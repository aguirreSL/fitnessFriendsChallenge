...
from .views import add_activity, custom_logout, profile, create_group, group_list, create_challenge, challenge_list, weight_tracker, challenge_list, create_challenge, edit_challenge#,add_diet_log
from . import views
